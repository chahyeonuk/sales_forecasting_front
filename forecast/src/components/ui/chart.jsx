...
function getPayloadConfigFromPayload(config, payload, key) {
  ...
  const payloadByValueKey = payload.payload && payload.payload[key]
  const configLabelKey = payload.dataKey

  let configByKey = key && config[key]

  if (
    key &&
    payloadByValueKey &&
    typeof payloadByValueKey === "object" &&
    payloadByValueKey !== null
  ) {
    configByKey = payloadByValueKey
  }

  return configLabelKey && config[configLabelKey] || configByKey
}
