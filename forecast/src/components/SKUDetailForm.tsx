...
interface SKUDetailFormProps {
  sku: any
  onSave: (updatedSKU: any) => void
  onCancel?: () => void
  isNew?: boolean
}

export function SKUDetailForm({ sku, onSave, onCancel, isNew = false }: SKUDetailFormProps) {
            ...
            <div>
              ...
              {isEditing ? (
                <Select
                  ...
                  onValueChange={(value: string) => updateField('supplier', value)}
                >
                  <SelectTrigger className="mt-1">
          ...
          <div className="flex items-center justify-between p-4 border rounded-lg">
            ...
            <Switch
              ...
              onCheckedChange={(checked: boolean) =>
                updateField('discontinued', checked)
              }
              disabled={!isEditing}
            />
          </div>
